                        ...
                        <div class="col-lg-5 col-md-6 col-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal necesitas-registration-fromd"  method="POST" action="<?php echo site_url('admin/authentication/forgot_password'); ?>">
                                        ...
                                        <div class="form-group Ingresar-button">
                                            ...
                                            <a href="<?php echo site_url('saas/signup'); ?>" class="Registrate-link"><?php echo _l('have_acount') ?><span><?php echo _l('sign_up_here') ?></span></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
